...
if __name__ == '__main__':
    ...
    # Check that we are not overwriting some previous experimentur model and don't care about o
    # Comment these lines if you are developing yoverwritting
    ...
    train_labels = [os.path.join(train_data_dir, f) for f in os.listdir(train_data_dir)
                       if f.endswith('X_train.npy')]
    eval_labels = [os.path.join(dev_data_dir, f) for f in os.listdir(dev_data_dir)
                      if f.endswith('X_dev.npy')] 
